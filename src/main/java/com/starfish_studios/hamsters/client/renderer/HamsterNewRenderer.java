...
public class HamsterNewRenderer extends GeoEntityRenderer<HamsterNew> {
    ...
    @Override
    public void render(HamsterNew animatable, float entityYaw, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight) {
