...
public class RightSittingHamsterModel<T extends HamsterNew> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        head.addOrReplaceChild("armorBipedHead", CubeListBuilder.create().texOffs(1, 11).addBox(-2.5F, -4.0F, -2.0F, 5.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 1.5F, -2.0F));

        head.addOrReplaceChild("rightEar", CubeListBuilder.create().texOffs(0, 11).mirror().addBox(-2.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.01F)).mirror(false), PartPose.offset(-1.0F, -1.5F, -2.0F));

        head.addOrReplaceChild("leftEar", CubeListBuilder.create().texOffs(0, 11).addBox(0.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offset(2.0F, -1.5F, -2.0F));

        head.addOrReplaceChild("cheeks", CubeListBuilder.create().texOffs(20, 13).addBox(7.0F, -1.5F, -2.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        head.addOrReplaceChild("sleep", CubeListBuilder.create(), PartPose.offset(0.5F, 2.5F, 0.0F));

        body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(19, 0).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 1.0F));

        body.addOrReplaceChild("rightHand", CubeListBuilder.create().texOffs(24, 2).mirror().addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 1.5F, -3.5F, 2.3126F, 0.2618F, 0.0565F));

        body.addOrReplaceChild("leftHand", CubeListBuilder.create().texOffs(24, 2).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 1.5F, -3.5F, 2.3126F, -0.2618F, -0.0698F));

        PartDefinition legs = root.addOrReplaceChild("legs", CubeListBuilder.create(), PartPose.offset(1.5F, -1.0F, -1.0F));

        legs.addOrReplaceChild("leftFoot", CubeListBuilder.create().texOffs(24, 2).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 3.0F));

        legs.addOrReplaceChild("rightFoot", CubeListBuilder.create().texOffs(24, 2).mirror().addBox(-1.0F, 0.0F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 0.0F, 3.0F));
